 ...
 return (
  <div className={textColor}>
   <div class="row justify-content-center">
    <div class="col-md-12 Continue-forgotpassword">
     ...
     <p className='mt-3'>You may receive <b>WhatsApp</b> and <b>SMS</b> notifications from us for security and login purposes.</p>
